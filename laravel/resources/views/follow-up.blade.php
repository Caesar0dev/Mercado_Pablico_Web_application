    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="flow-up.html" class="nav-item nav-link active"><i class="fas fa-sticky-note me-2"></i>Seguimiento</a>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="bg-secondary text-center rounded p-4" style="height: 524px;">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0 me-2">Seguimiento | </h3>
                        <h6 class="mb-0">Oportunidades en seguimiento.</h6>
                    </div>
                    <a href="">Show All</a>
                </div>
