    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar bg-secondary navbar-dark">
            ...
            <div class="navbar-nav w-100">
                ...
                <a href="calendar.html" class="nav-item nav-link active"><i class="fas fa-calendar me-2"></i>Calendario</a>
        ...
        <div class="container-fluid pt-4 px-4">
            <div class="h-100 bg-secondary rounded p-4">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h3 class="mb-0 me-2">Calendario | </h3>
                        <h6 class="mb-0"> Aquí te mostramos las fechas de tus oportunidades en seguimiento.</h6>
                    </div>
                    <a href="">Show All</a>
                </div>
                <div id="calender"></div>
