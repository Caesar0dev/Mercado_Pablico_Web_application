        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <a href="/signin" class="btn btn-primary py-2 px-4 ms-3">Sign In</a>
                </div>
            </nav>
                ...
                <div class="row justify-content-end">
                    <div class="col-lg-8 col-md-6">
                        <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                            <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Ofertaadjudicada</a>. All Rights Reserved.
                            Designed by <a class="text-white border-bottom" href="https://freelancer.com/u/kozaktr">Marsel Kozak</a></p>
                        </div>
                    </div>
                </div>
            </div>
