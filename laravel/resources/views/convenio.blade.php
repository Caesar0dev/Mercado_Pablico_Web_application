                ...
                <div class="row g-4">
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-secondary rounded d-flex align-items-center p-4 card">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">Mercado</p>
                                <h6 class="mb-0">Da una mirada general de los Convenios Marco presentes e Históricos.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-4">
                    ...
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-secondary rounded d-flex align-items-center p-4 card">
                            ...
                            <div class="ms-3">
                                <p class="mb-2">MP Proveedores</p>
                                <h6 class="mb-0">Identifica a los principales proveedores del Estado en tus productos de interés.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-secondary rounded d-flex align-items-center p-4 card">
                            <i class="fa fa-users fa-3x text-primary" aria-hidden="true"></i>
                            <div class="ms-3">
                                <p class="mb-2">MP Compradores</p>
                                <h6 class="mb-0">Monitorea el comportamiento de compra del Estado en los rubros de tu interés.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-xl-4">
                        <div class="bg-secondary rounded d-flex align-items-center p-4 card">
                            <i class="fas fa-chart-line fa-3x text-primary"></i>
                            <div class="ms-3">
                                <p class="mb-2">Precios Unitarios</p>
                                <h6 class="mb-0">Revisa precios y tendencias en tus productos de interés.</h6>
                            </div>
                        </div>
                    </div>
                </div>
